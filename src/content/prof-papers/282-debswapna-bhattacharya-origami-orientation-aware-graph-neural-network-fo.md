...
source_hash: "a2c990ebb954dd0c6c49026b96b11228ca218c68d7b861753493f1d36af3dab2"
sequence: 282
...
**The paper assumes:** equivariant graph neural networks, geometric deep learning, SO(3)-equivariance, message passing on graphs, 3D molecular representation learning
**Already in this field?** Skip this entirely if you already understand equivariant graph neural networks and geometric deep learning concepts applied to 3D molecular data.

To understand the ORIGAMI paper's core methodology—an orientation-aware graph neural network preserving SO(3)-equivariance for protein interface assessment—this background focuses on geometric deep learning, especially on graphs and equivariant neural networks. The rigorous course option offers a deep, structured university-level treatment of 3D data and geometric deep learning principles, while the fast track provides a concise, intuition-driven series of expert talks and explanations on graph neural networks and geometric deep learning. Choose the rigorous course for a thorough foundation and the fast track for a quicker, concept-focused overview.

### The course
_Rigorous, and the one to pick if you want to hold this material properly._

▶ [KAIST CS479: Machine Learning for 3D Data (Spring 2026)](https://www.youtube.com/playlist?list=PLyi5FHzX7hBxJnkFZa-9oVZnTsQcux79M) — Minhyuk Sung · 15 videos · 15.4h across 15 episodes

**Watch only this:** Lectures 2, 3, 4 (both parts), and 15 — about 5 hours total. These cover 3D representations, point clouds, 3D rotations/quaternions, and 3D generation, which are essential to grasping the geometric deep learning and equivariant message passing in the paper.

*Why it unblocks this paper:* KAIST CS479: Machine Learning for 3D Data (Spring 2026) is a university-level course that covers 3D representations, rotations, point clouds, and implicit neural representations, directly relevant to understanding SO(3)-equivariance and spatial graph neural networks used in ORIGAMI.

*If you want all of it:* 15.4 hours across all 15 episodes.
...
**Watch only this:** Episodes 3, 5, 7, 11, and 13 — about 3.75 hours total. These cover relational inductive biases, theoretical foundations, Stanford CS224W introduction to graphs, applications, and graph convolutional networks, giving a focused overview of GNNs and geometric deep learning.

*Why it unblocks this paper:* Adam Safron's 'Graph neural networks and geometric deep learning' playlist offers a concise, expert-curated set of talks and explanations on graph neural networks and geometric deep learning principles, providing intuition and foundational knowledge relevant to the paper's approach.
